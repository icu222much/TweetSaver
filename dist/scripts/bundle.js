...
(function () {
  ...
  var TWITTER_ENDPOINT = 'http://tweetsaver.herokuapp.com';
  var TWITTER_ERROR_MESSAGE = 'Twitter query failed. Please try another query.';
  var TWITTER_MAX_TWEETS = '10';
  var LOCAL_STORAGE_TWEETS = 'storedTweets';
  ...
  function preventHorizontalScroll() {
    /* if .tweet is dragged off the viewport */
  ...
  function loadSavedTweets() {
    var storage = getStorageItem(LOCAL_STORAGE_TWEETS) || {};
    for (var key in storage) {
      if (key !== 'undefined') {
        var payload = Object.assign({ id: key }, storage[key]);
  ...
  function setupObserver() {
    ...
    var target = document.getElementsByClassName('list__saved')[0];
  ...
  function onSearchTweet() {
    var query = escapeHtml($('.search__input').val());
  ...
  function createTweetDom(_ref) {
    ...
    return "<div class=\"tweet\" data-id=\"" + (id || Math.random()) + "\">" + "<div class=\"tweet__close\">X</div>" + ("<img class=\"tweet__avatar\" src=\"" + (avatar || '') + "\" />") + "<div class=\"tweet__content\">" + "<div class=\"tweet__meta\">" + ("<span class=\"tweet__name\">" + (name || '') + "</span>") + "<span class=\"tweet__handle\">" + ("<a class=\"tweet__handle-link\" href=\"http://www.twitter.com/" + (handle || '') + "\" target=\"_blank\">") + ("" + (handle || '')) + "</a>" + "</span>" + ("<span class=\"tweet__date\">" + (date || '') + "</span>") + "</div>" + ("<p class=\"tweet__message\">" + (linkify(message) || '') + "</p>") + "</div>" + "</div>";
  }
